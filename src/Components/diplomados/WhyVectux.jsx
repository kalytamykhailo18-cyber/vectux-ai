        ...
        <section className="relative px-8 sm:px-14 py-20 md:py-28" style={{ background: 'linear-gradient(to bottom, #5058d2 0%, #5a68d8 35%, #5f70dc 65%, #6478e0 100%)' }}>
            <div className="grid grid-cols-1 min-[1100px]:grid-cols-4 gap-8 lg:gap-12 max-w-[1200px] lg:max-w-[1400px] mx-auto">
                ...
                <div data-aos="fade-left" data-aos-duration="600" data-aos-delay="200" className="p-6 relative">
                    ...
                    <p className="pt-4 text-white/90 font-Manrope text-[16px] sm:text-[20px] font-[500] mb-4 italic text-center min-[1100px]:text-right">
                        Quiero ayudarte a pensar con claridad en la era digital y a tomar decisiones con visión.
                    </p>
                    <p className="text-white/90 font-Manrope text-[16px] sm:text-[20px] font-[500] mb-4 italic text-center min-[1100px]:text-right">
