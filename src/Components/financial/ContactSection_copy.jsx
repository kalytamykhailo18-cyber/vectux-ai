...
const contactData = {
    title: "Domina el lenguaje de las finanzas del futuro.",
    text: "Los datos financieros son el nuevo activo estratégico. Aprende a extraer su valor.",
    subtitle: "Analiza, predice y decide con confianza.",
...
const ContactSection = () => {
    return (
        <section id="contact" className="relative overflow-hidden" style={{ background: 'linear-gradient(to bottom, #3a50cc 0%, #4550cc 35%, #3a45c5 65%, #343ec2 100%)' }}>
