...
const structureData = {
    ...
    text: "El Diplomado en Financial Analytics te prepara para dominar las herramientas más avanzadas de análisis financiero, desde la modelación de riesgos hasta la automatización de reportes y la creación de estrategias de inversión basadas en datos.",
    modules: [
        {
            icon: TrendingUp,
